...
var ganttStudentRowsContainer = null;
var ganttStudentRows = [];
var phaseLanes = [];
var workspaceViewButtons = [];
var workspaceListView = null;
var workspacePhaseView = null;
var workspaceGanttView = null;
...
function syncDashboardDom() {
  ...
  ganttStudentRowsContainer = document.getElementById("ganttStudentRows");
  ganttStudentRows = Array.prototype.slice.call(document.querySelectorAll("[data-gantt-student-row]"));
  ...
  workspaceGanttView = document.getElementById("workspaceGanttView");
